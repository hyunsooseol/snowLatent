      ...
      .init = function() {
        ...
        self$results$instructions$setContent(private$.htmlwidget$generate_accordion(
          ...
          content = paste(
            ...
            '<ul>',
            '<li>It utilizes logistic regression and employs a 3-step approach based on <b>slca</b> R package.</li>',
            '<li>The<b>slca::regress()</b>is used to explore the influence of external variables on the latent class variable within an estimated <b>slca</b> model.</li>',
